...
class SequenceMatch:
    def __init__(self, net_builder, num_classes, ema_m, T, p_cutoff, lambda_u, \
        ...
        """
        class SequenceMatch contains setter of data_loader, optimizer, and model update methods.
        Args:
        ...
        super(SequenceMatch, self).__init__()
    ...
    def train(self, args, logger=None):
        ...
        for (_, x_lb, y_lb), (x_ulb_idx, x_ulb_w, x_ulb_m, x_ulb_s) in zip(self.loader_dict['train_lb'],
            ...
            x_lb, x_ulb_w, x_ulb_m, x_ulb_s = x_lb.cuda(args.gpu), x_ulb_w.cuda(args.gpu), x_ulb_m.cuda(args.gpu), x_ulb_s.cuda(args.gpu)
            ...
            with amp_cm():
                ...
                unsup_loss_sm, _ = consistency_loss_uda(logits_x_ulb_s,
                                                        logits_x_ulb_m,
                                                        classwise_acc,
                                                        self.it,
                                                        args.dataset,
                ...
                unsup_loss_sw, _ = consistency_loss_uda(logits_x_ulb_s,
                                                        logits_x_ulb_w,
                                                        classwise_acc,
                                                        self.it,
                                                        args.dataset,
