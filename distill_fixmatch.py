...
from models.distillmatch.distill_fixmatch import DistillFixMatch
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # SET Distill_FixMatch: class Distill_FixMatch in models.Distill_FixMatch
    ...
    model = DistillFixMatch(_net_builder,
                    args.num_classes,
                    args.ema_m,
                    args.T,
                    args.p_cutoff,
    ...
    ## set SGD and cosine lr on Distill_FixMatch
    ...
    ## set DataLoader on Distill_Distill_FixMatch
    ...
    # START TRAINING of Distill_Distill_FixMatch
    trainer = model.train
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name', type=str, default='distill_fixmatch')
    ...
    '''
    Training Configuration of DistillMatch
    '''
