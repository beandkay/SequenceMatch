...
from models.distillmatch.distill_uda import DistillUda
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    ## set SGD and cosine lr on DistillUDA 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='distill_uda')
    ...
    '''
    Training Configuration of DistillUDA
    '''
