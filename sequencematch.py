...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = SequenceMatch(_net_builder,
                     args.num_classes,
                     args.ema_m,
                     args.T,
                     args.p_cutoff,
    ...
    if args.dataset.lower() != "imagenet":
        ...
        _eval_dset = SSL_Dataset(args, alg='sequencematch', name=args.dataset, train=False,
                                num_classes=args.num_classes, data_dir=args.data_dir)
    ...
    ## set DataLoader and ulb_dset on SequenceMatch
    ...
    # START TRAINING of SequenceMatch
    trainer = model.train
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name', type=str, default='sequencematch')
    ...
    '''
    Training Configuration of SequenceMatch
    '''
