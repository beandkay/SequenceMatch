...
from models.distillmatch.distill_flexmatch import DistillFlexMatch
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # SET DistillFlexMatch: class DistillFlexMatch in models.DistillFlexMatch
    ...
    model = DistillFlexMatch(_net_builder,
                    args.num_classes,
                    args.ema_m,
                    args.T,
                    args.p_cutoff,
    ...
    ## set SGD and cosine lr on DistillFlexMatch
    ...
    ## set DataLoader and ulb_dset on DistillFlexMatch
    ...
    # START TRAINING of DistillFlexMatch
    trainer = model.train
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name', type=str, default='distill_flexmatch')
    ...
    '''
    Training Configuration of DistillFlexMatch
    '''
    ...
    parser.add_argument('--distill_T', default=3.0, type=float)
    ...
    '''
    parser.add_argument('--net', type=str, default='WideResNetSD')
